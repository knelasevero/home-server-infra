...
Fist edit your connections, and make the wired connection on your laptop have a static ip in the 192.168.0.x range. Plug the switch to a power socket and connect your laptop to the port 1 of the switch. Access the switch in the 192.168.0.1 in a browser (this will be different for different switches).
...
Navigate to  "VLAN" > "802.1Q VLAN", and enable "802.1Q VLAN" and apply.